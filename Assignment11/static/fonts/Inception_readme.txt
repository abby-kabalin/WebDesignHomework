...
++L'usage de cette police est GRATUIT pour une utilisation personnelle et/ou non-commerciale. 
  ...
  Merci de bien vouloir également m'envoyer vos créations ;)

++L'usage de cette police est INTERDIT pour une utilisation professionnel et/ou commercial 
  sans vous acquitter de la licence commerciale. (voir ci-dessous comment me contacter pour les détails).

++Vous n'êtes pas autorisé à distribuer cette police, quelque soit la forme (web, cd, zip, ...) 
  sans ma permission expresse. Contactez-moi pour les détails.
